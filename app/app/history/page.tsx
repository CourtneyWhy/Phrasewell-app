...
export default function HistoryPage() {
  return (
    <div className="app-container" style={{ paddingTop: "var(--space-3)", paddingBottom: "var(--space-5)" }}>
      <PageTitle>History</PageTitle>
      <p className="text-body-muted" style={{ fontSize: 14, marginTop: 0, marginBottom: "var(--space-4)" }}>
