...
export const FLOWS: FlowDef[] = [
  ...
  },
  {
    ...
    trigger_description: "July 21 — segment: waitlist + beta active, exclude purchased",
    goal: "Maximize LTD sales July 28 – August 3. Remove from flow on purchase.",
    lifecycle_stage: "founder_ltd",
    klaviyo_flow_name: "Founder LTD Launch Sequence",
    sort_order: 6,
    emails: [
      { send_timing: "July 21", subject: "Founder access opens next week", preview_text: "July 28 — lifetime access for waitlist.", body_outline: "Tease founder LTD. What's included. July 28 date.", goal: "Awareness", cta: "Mark your calendar", graphic_recommendation: "Landing page screenshot" },
      { send_timing: "July 23", subject: "Why we built Phrasewell", preview_text: "From an adoptive mom who needed words, not theory.", body_outline: "Founder story email.", goal: "Trust", cta: "Read our story", graphic_recommendation: "Founder note" },
      { send_timing: "July 25", subject: "Meet beta parents", preview_text: "Real feedback from foster and adoptive families.", body_outline: "Social proof / testimonials.", goal: "Proof", cta: "See what parents say", graphic_recommendation: "Beta testimonial quotes" },
      { send_timing: "July 27", subject: "Tomorrow — Founder access opens", preview_text: "Waitlist gets first access.", body_outline: "Eve of launch. Pricing preview. FAQ link.", goal: "Anticipation", cta: "Get ready", graphic_recommendation: "Countdown — script card" },
      { send_timing: "July 28", subject: "Founder access is open", preview_text: "Lifetime access — limited window.", body_outline: "LAUNCH. Link to checkout. What's included.", goal: "Convert", cta: "Get Founder Lifetime Access", graphic_recommendation: "Pricing page screenshot" },
