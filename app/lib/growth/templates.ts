...
Not a lecture. Not a course. Not another 300-page book.
...
export const BLOG_TITLES = [
  "What to Say When Your Foster Child Says \"You're Not My Real Mom\"",
  ...
  "Why Traditional Consequences Don't Always Work for Kids With Trauma",
...
export const BEHAVIOR_CATEGORIES = [
  ...
  "Sensory and body struggles",
  "Defiance and control",
  "Nighttime, sleep, and bedtime",
];

export const CREATOR_PITCH =
  "Phrasewell gives foster, adoptive, and kinship parents exact words to say in hard behavior moments. I'm inviting a small group of early testers and would love feedback from parents who live this.";
