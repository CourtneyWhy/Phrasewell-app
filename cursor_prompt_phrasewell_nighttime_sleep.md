# Cursor Prompt — Add Phrasewell Category: Nighttime & Sleep

You are adding the next approved content category to Phrasewell.

## Category to add

Category ID: `nighttime_sleep`  
Category label: `Nighttime & Sleep`  
Category subtitle: `Wind down without a fight`

Use the attached JSON file:

`phrasewell_nighttime_sleep_v1_universal_3variants.json`
...
4. Bedwetting accidents
5. Hoarding items in bed
6. Sneaking out at night
7. Refusing to sleep alone
8. Early waking and roaming
...
```ts
category_id: "nighttime_sleep"
behavior_id: "nightmares"
age_band_id: "4_7"
...
- “scared of the dark”
- “wet the bed”
- “hiding things in bed”
- “sneaking downstairs”
- “will not sleep alone”
- “wakes too early”
- “roaming in the morning”
...
- Nighttime & Sleep appears as a category.
- The category shows all 8 behavior tiles.
